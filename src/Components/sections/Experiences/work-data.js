const work_experience_data = {
  altimetrik: {
    ...
    bullet_points: [
      "Working as a Software Engineer on SoFi Tech Solutions' core payment infrastructure, powering digital banking services for fintech clients.",
      "Modernizing legacy Python payment processing workflows to improve maintainability, reliability, and code quality.",
      "Implementing Mastercard and Visa network mandates and compliance requirements across payment processing systems.",
      ...
      "Using Splunk and Datadog to monitor application logs, trace errors, and troubleshoot production issues",
      "Contributing to release planning and rollout strategy by managing feature flags across multiple environments",
    ],
    technology: [
      "Python",
