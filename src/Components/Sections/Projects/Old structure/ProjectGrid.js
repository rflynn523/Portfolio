...
class ProjectGrid extends React.Component {
  constructor(props) {
    ...
    this.state = {
      activeState: (
        <UnselectedProjectGrid
          allProjects={this.props.allProjects}
          onUnselectedGrid={this.switchToSelectedGrid}
        />
      ),
    };
  }
  ...
  switchToSelectedGrid(id) {
    this.setState({
      activeState: (
        <SelectedProjectGrid
          allProjects={this.props.allProjects}
          onSelectedGrid={this.switchToUnSelectedGrid}
          onUnselectedGrid={this.switchToSelectedGrid}
          active={id}
        />
      ),
  ...
  render() {
    return <div className="Project_Grid_View">{this.state.activeState}</div>;
  }
}
