...
class Work extends React.Component
{
    ...
    solute = 
    {
        ...
        bullet_points : ["Backend work in Python, included various feature work, creating unit tests, adding data validation with pydantic.",
    ...
    CP = 
    {
        ...
        bullet_points : ["Developed automation scripts that create Revit models for teams within the company. ", 
    ...
    shipt =
    {
        ...
        bullet_points : ["Shopped for and delivered groceries to the customer with in the delivery window. Along the way I would comunicate with the customer about the status of their items."],
        technology : [],
        links : "Shipt"
    }
    ...
    nass = 
    {
        ...
        bullet_points : ["Performed various tasks that came up, which included employee computer setup and configuration, data entry, and budget organization."],
        technology : [],
    ...
    summerCamp = 
    {
        ...
        bullet_points : ["Worked as a team with the other counselors to provide fun and safe activities for the campers"],
        technology : [],
