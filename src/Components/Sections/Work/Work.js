...
class Work extends React.Component {
  ...
  shipt = {
    ...
    bullet_points: [
      "Shopped for and delivered groceries to the customer with in the delivery window. Along the way I would comunicate with the customer about the status of their items.",
    ],
    technology: [],
    links: "Shipt",
  };
