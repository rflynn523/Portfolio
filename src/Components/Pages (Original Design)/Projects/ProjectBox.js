...
// import './Project.css'
import ProjectTitleCard from "../../Sections/Projects/ProjectTitleCard";
...
class ProjectBox extends React.Component {
  constructor(props) {
    ...
    this.state = {
      class: "Title",
      active: <ProjectTitleCard project={this.props.project} />,
    };
  }
  ...
  showDetails() {
    if (this.state.class === "Title") {
      ...
      ReactGA.event({
        category: "Project Details Viewed",
        action: this.props.project.title,
      });
      this.setState({
        class: "Details",
        active: (
