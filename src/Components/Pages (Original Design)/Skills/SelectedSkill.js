...
class SelectedSkill extends React.Component
{
    ...
    titles = this.props.allObjects.map(object => {return object.title})
    ...
    constructor(props)
    {
        ...
        this.state = {activeCard: this.updateActiveCard(this.props.active), activeCardIndex: this.titles.indexOf(this.props.active)};
    }
    ...
    updateActiveCard(id)
    {
        ...
        this.setState({activeCard: <DetailedCard onClick={this.props.onSelected} object={selectedObject}/>, 
                       activeCardIndex: index});

        // Only need initially
        return <DetailedCard onClick={this.props.onSelected} object={selectedObject}/>;
    }
    ...
    getOtherCards()
    {
        ...
        for(let i = 0; i < this.props.allObjects.length; i++)
            if(i === this.state.activeCardIndex)
                ...
                otherCards.push(<Card onClick={this.updateActiveCard} object={this.props.allObjects[i]}/>)
